...
public class debugResult : MonoBehaviour {
	...
	int itemwidth = 130;
	string cmdLabel, keyLabel, inputLabel;
	...
	void OnGUI(){
		...
		if(GUI.Button(new Rect(horiPosition, vartPosition+iDif*6, infowidth, infoheight), "やめるしかねー", buttonStyle)){
			Application.Quit();
		}
	}
